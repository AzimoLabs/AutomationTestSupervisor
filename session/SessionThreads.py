...
class ApkInstallThread(threading.Thread):
    ...
    def __init__(self, aapt_controller, device, apk_name, apk_path):
        super().__init__()
    ...
    def run(self):
        ...
        package = self._get_apk_package(self.apk_name, self.apk_path)
    ...
    def _get_apk_package(self, apk_name, apk_path):
        dump = self.aapt_controller.dump_badging(apk_path)
        ...
        if regex_result:
            ...
            message = "Unable to find package of .*apk file: " + apk_name
